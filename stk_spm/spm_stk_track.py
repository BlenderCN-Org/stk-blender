    ...
    def processObject(self, object, stktype):
        ...
        if object.particle_systems is not None and len(object.particle_systems) >= 1 and \
            ...
            if object.particle_systems[
                0].settings.dupli_object is not None:  # and getObjectProperty(object.particle_systems[0].settings.dupli_object, "type", "") == "object":
                self.m_objects.append(object)
            else:
        ...
        for obj in self.m_objects:
            try:
                ...
                if trigger_type == "point":
                    ...
                    radius = (
                             obj.dimensions.x + obj.dimensions.y) / 4  # divide by 2 to get average size, divide by 2 to get radius from diameter
                    f.write(
